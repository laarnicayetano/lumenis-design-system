...
/* Custom hairline box over a visually-hidden native input (keeps keyboard/SR
   semantics). Softly rounded (tokens/surfaces.css) — checked state fills
   with --accent so it recolors inside a [data-subbrand] scope. */
        ...
        >
          {checked ? (
            <svg width="10" height="8" viewBox="0 0 10 8" fill="none">
              <path d="M1 4L3.6 6.5L9 1" stroke="var(--accent-contrast)" strokeWidth="1.5" strokeLinecap="square" />
            </svg>
          ) : null}
        </span>
      </span>
