...
/* Pill-shaped, hairline-bordered chip (tokens/surfaces.css — digital
   surfaces round softly). Selected state fills with the ink/paper pair (not
   --accent) so it reads as a pressed toggle rather than a brand highlight —
   mirrors how selected states work elsewhere in the system. */
  ...
  return (
    <span
      ...
      style={{
        ...
        fontFamily: 'var(--font-sans)', fontSize: 'var(--text-caption)', letterSpacing: 'var(--tracking-caption)',
        ...
        background: selected ? selectedBg : 'transparent', color: selected ? selectedFg : fg,
