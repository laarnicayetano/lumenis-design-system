...
**New here?** See [README.md](README.md) for setup, local preview, and how to use this across Claude Code / Design / Desktop / claude.ai. This file is the detailed reference underneath that.
...
For exactly where to get the licensed files and which paths to drop them at, see [README.md → Fonts](README.md#fonts--where-to-get-them-where-they-go).
