      ...
      >
        ...
        >
          ...
          <Prose tone="rgba(255,255,255,.75)" maxWidth="34ch">
            Two handpieces work in tandem to stimulate collagen remodeling beneath the skin's
            surface — treating the face and neck in a single session.
          </Prose>
          <div style={{ display: "flex", gap: "var(--space-3)" }}>
            {AREAS.map((a) => (
              <Tag key={a} tone="inverse" selected={area === a} onClick={() => setArea(a)}>
                {a}
              </Tag>
            ))}
          </div>
