...
export function ProviderCTA({ onBook }: ProviderCTAProps) {
  return (
    <section
      id="providers"
      style={{
    ...
    >
      ...
      >
        <Eyebrow style={{ color: "var(--lum-white)", marginBottom: "var(--space-5)" }}>
          A bright solution for dry eyes
        </Eyebrow>
        <Headline tone="var(--lum-white)" style={{ marginBottom: "var(--space-5)" }}>
        ...
        >
          Connect with a certified eye-care professional and take the first step toward lasting
          dry-eye comfort.
        </Prose>
        <div
          style={{
      ...
      <div style={{ maxWidth: "var(--page-max)", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              OptiLIGHT™ by Lumenis — establishing light as a healing energy for the management of
              dry eye disease.
            </p>
          </div>
        ...
        >
          ...
          >
            © 2026 Lumenis Be Ltd. OptiLIGHT™ and OPT™ are trademarks of Lumenis. For professional
            use.
          </div>
          <div
            style={{
          ...
          >
            <a href="#" onClick={(e) => e.preventDefault()} style={{ color: "inherit" }}>
              Privacy
            </a>
            <a href="#" onClick={(e) => e.preventDefault()} style={{ color: "inherit" }}>
              Terms
...
export function BookModal({ open, onClose }: BookModalProps) {
