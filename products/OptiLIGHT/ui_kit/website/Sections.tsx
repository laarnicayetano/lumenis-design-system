    ...
    <section id="treatment" style={{ padding: "var(--space-10) var(--page-gutter)" }}>
      <div style={{ maxWidth: "var(--page-max)", margin: "0 auto" }}>
        <div style={{ maxWidth: 640, marginBottom: "var(--space-8)" }}>
          ...
          <Headline as="h2" size="small" mix="LIGHT">
        ...
        >
          {VALUE_PROPS.map((it) => (
            <Card key={it.t}>
              ...
              <h3 style={{ fontFamily: "var(--font-sans)", fontSize: 18, margin: "0 0 9px" }}>
                {it.t}
              </h3>
              <p
                style={{
    ...
    >
      ...
      >
        <div style={{ maxWidth: 560, color: "var(--lum-white)" }}>
          <Eyebrow style={{ color: "inherit", marginBottom: "var(--space-5)" }}>
          ...
          <Prose tone="rgba(255,255,255,.86)" maxWidth="28ch">
            The signature prism falls across the eye — a reminder that relief can feel as gentle and
...
const SHOWCASE_DATA: Record<string, ShowcaseEntry> = {
  pro: {
    ...
    >
      ...
      >
        ...
        <div>
          ...
          />
          <Eyebrow style={{ color: "var(--lum-blue)", marginBottom: "var(--space-3)" }}>
            {d.eyebrow}
          </Eyebrow>
          <Headline as="h2" size="small" style={{ marginBottom: "var(--space-5)" }}>
            {d.title}
          </Headline>
          <Prose size="subtitle" style={{ marginBottom: "var(--space-6)" }}>
            {d.body}
          </Prose>
