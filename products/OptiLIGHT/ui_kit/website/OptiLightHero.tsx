...
interface OptiLightHeroProps {
  onBook: () => void;
}
export function OptiLightHero({ onBook }: OptiLightHeroProps) {
  return (
    <section
      id="top"
    ...
    >
      ...
      >
        <div>
          <Badge tone="accent" style={{ marginBottom: "var(--space-5)" }}>
            FDA-cleared · Dry eye disease
          </Badge>
          <Headline mix="SOLUTION" style={{ marginBottom: "var(--space-5)" }}>
          ...
          >
            OptiLIGHT™ elevates dry-eye management with Lumenis' patented Optimal Pulse Technology —
            the safe, precise, elegant procedure you want and the comfortable therapy your patients
            need.
          </Prose>
          <div
            style={{
          ...
          >
            ...
            <Button variant="accent-outline" onClick={onBook}>
              How it works
            </Button>
          </div>
          <div
