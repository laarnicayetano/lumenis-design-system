...
- **slides** — `Slides.dc.html`: seven 1920×1080 slides (title, section divider, split content, proof points, quote, product grid, closing) on the deck stage, so arrow keys, the thumbnail rail and PDF export all work out of the box.
