  ...
  return (
    <header
      style={{
        ...
        padding: 'var(--space-5) var(--page-gutter)', position: 'sticky', top: 0, zIndex: 10,
        background: 'rgba(255,255,255,.9)', backdropFilter: 'var(--blur-glass)',
    ...
    >
      ...
      <Button
        variant="accent"
        size="sm"
        onClick={() => document.getElementById('provider-form')?.scrollIntoView({ behavior: 'smooth' })}
