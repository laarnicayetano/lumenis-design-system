...
async function writeGenerated(relOutPath: string, content: string): Promise<void> {
...
function guidelineMdx(title: string, card: DsCard, relSrc: string, publicSrc: string): string {
...
source guideline instead. Regenerated by \`scripts/generate-storybook-foundations.ts\`.
...
directly. Regenerated by \`scripts/generate-storybook-foundations.ts\`.
...
\`scripts/generate-storybook-foundations.ts\`. Combined into one page,
...
\`scripts/generate-storybook-foundations.ts\` (same esbuild step the old
